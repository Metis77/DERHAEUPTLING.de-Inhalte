...
1. [ ] /webdesign (stärkstes Keyword, definiert Tonalität)
...
## Backlog: Nach Relaunch (iterativ)

- [ ] Restliche Ratgeber-Artikel schreiben
- [ ] Weitere Case Studies ergänzen (mit harten Metriken wenn verfügbar)
- [ ] Webdesign-Unterseiten evaluieren (nach 6 Monaten Keyword-Daten)

## Backlog: Technik & Daten

- [ ] CMS/Tech-Stack entscheiden (beeinflusst Performance-Strategie)
- [ ] Schema.org Markup-Plan pro Seitentyp (ProfessionalService, FAQPage, BreadcrumbList, Article, Service, AggregateRating)
- [ ] Bestandskunden befragen: Vorher/Nachher für Case Studies
- [ ] Testimonials sammeln (mit Name + Rolle)

## Erledigt

- [x] **Setup:** Projektstruktur, CLAUDE.md, Inspirationsquellen analysiert, Sitemap/IA geplant
